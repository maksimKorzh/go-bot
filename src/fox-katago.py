...
# Do not store screenshot to disk
def screenshot_mss(region=None):
  with mss.mss() as sct:
    if region:
...
# Override pyautogui.screenshot
pg.screenshot = screenshot_mss

# Constants (modify according to your screenshot parameters)
CELL_SIZE = 50
BOARD_TOP_COORD = -14
BOARD_LEFT_COORD = 198

# Go playing program
ENGINE = '/home/cmk/katago/katago gtp -config /home/cmk/katago/gtp.cfg -model /home/cmk/katago/kata1-b10c128.txt.gz'
BOARD_SIZE = 19
KOMI = 5.5
...
def locate_stone(color):
  ...
  # Load template
  template = cv2.imread('../img/fox-' + color + '.png', cv2.IMREAD_COLOR)
